          ...
          <Card className="shadow-2xl border-0 rounded-3xl bg-white overflow-hidden">
            <CardContent className="p-8">
              ...
              {currentStep === 2 ? (
                <div className="space-y-8">
                  <div className="text-center space-y-4">
                    <div>
                      ...
                      <p className="text-base text-gray-600 max-w-lg mx-auto">
                        ...
                        and to identify you on the platform.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="max-w-md mx-auto space-y-4">
                    ...
                    <div className="text-sm text-gray-500">
                      <p className="mb-1">Your profile will be available at:</p>
                ...
                <div className="text-center space-y-8 py-12">
                  <div className="space-y-3">
                    ...
                    <p className="text-base text-gray-600 max-w-2xl mx-auto">
                      Your academic profile has been created and verified. You
                      can now view your profile, submit manuscripts, or explore
                      the platform.
                    </p>
                  </div>
                ...
                (currentStep === 0 || (!showPreview && currentStep === 1)) && (
                  <div className="space-y-8">
                    <Tabs
                      value={activeTab}
