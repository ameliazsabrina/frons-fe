...
export function PublishingAdvantages() {
  ...
  return (
    <div ref={containerRef} className="bg-white">
      <header className="h-[25vh] lg:h-[40vh] w-full flex flex-col items-center justify-center">
        <Separator className="mb-16" />
        <h1 className="text-center font-anton uppercase text-primary text-5xl  md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl">
          With Fronsciers,
        </h1>
      </header>
